  ...
  function (declare, TiledMapServiceLayer, Extent, SpatialReference, TileInfo) {
    return declare(TiledMapServiceLayer, {
      ...
      getTileUrl: function (level, row, col) {
        ...
        zoom = level + 1;
        var num = (col + row) % 8 + 1;
        //var url = "http://mt" + (col % 4) + ".google.cn/vt/lyrs=m@226000000&hl=zh-CN&gl=cn&x=" + col + "&y=" + row + "&z=" + level + "&s=Galil";
        var url = "http://www.google.cn/maps/vt/lyrs=s@142&hl=zh-CN&gl=cn&x=" + col + "&y=" + row + "&z=" + level + "&s=Galil";
        return url;
        //return "http://www.google.cn/maps/vt/lyrs=s@142&hl=zh-CN&gl=cn&x={x}&y={y}&z={z}&s=Galil";
      }
    });
  }
)
